...
def get_args():
    ...
    parser.add_argument('--num_sem_categories', type=float, default=15)
...
def get_trans_args():
    parser = argparse.ArgumentParser(
        description='Transformer_parameter_setting')
    ...
    parser.add_argument('--attention_probs_dropout_prob', type=float, default=0.,
                        help='Dropout rate of attention parameter')
    parser.add_argument('--layer_norm_eps', type=float, default=1e-5,
                    help='Initialization settings of LN layer parameters')
